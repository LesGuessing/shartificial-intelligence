snark1 = ["...a relaxed environment far, far away from incomprehensible Planners, useless brainstorming sessions and noisy agency birthday parties.",
...
"...panicked Account people and planners left the room crying.",
	...
	"About two months. We had initial research. Data Analysis. Loop backs. Deep dive. More research. Oh and then the CMO went to Machu Pichu. So really only 6 weeks,\" the planner replies, with not a hint of guilt.\" ",
...
"As sure as the mustache under my nose, some 26-year old ex-sorority girl with a certificate in planning and two years of real world living, is chiming in with the ubiquitous: \"I like it. And I don't want to split hairs, maybe it\'s in the semantics, but (and here comes the phrase that kills all good ideas) I\'m not sure it's on-strategy.\" ",
...
"Whether it\'s fat, drunk CEO\'s pawing the underlings or complaining about \"Those Fuckin\' Jews\". Or it\'s double-talking planners who couldn\'t strategize their way out of a paper bag. Or, it\'s just Pepsi. This deep well of nonsense, incompetence and monumental greed will never run dry.",
...
"An agency can never have enough Planners.... Wink.",
...
"And this one my fellow copywriters can savor for years. A planner was heard to say... \"If we get this brief just right, the spots will literally write themselves.\" ",


"With rare exception, we\'re not Creatives anymore. We\'re box-checkers. We\'re imaginative strategy regurgitaters. We\'re planner pleasers. We\'re manifesto makers. We\'re 24-hour brand turnaraound specialists. We\'re the crafters of Frivolous Fuckwadian Digital Knick Knacks.",


"I thought I\'d do something equally rare. And spread a heaping helping of praise on my favorite people-- the Planners. But don't get too far ahead of yourselves. Because the three best Planners I've ever worked with aren\'t really Planners.",
